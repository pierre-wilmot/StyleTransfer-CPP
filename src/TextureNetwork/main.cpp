...
public:
  ...
  {
    _c1 = register_module("c1", torch::nn::Conv2d(torch::nn::Conv2dOptions(nc, nc, 3).padding(1)));
    ...
    _c7 = register_module("c7", torch::nn::Conv2d(torch::nn::Conv2dOptions(nc, nc, 3).padding(1)));
  }
